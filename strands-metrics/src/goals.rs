...
mod tests {
    ...
    fn test_warning_value_custom_ratio() {
        ...
        let warning: f64 = conn
            ...
            .unwrap();
        assert_eq!(warning, 50.0);
    }

    #[test]
    fn test_direction_display_and_parse() {
        assert_eq!(Direction::LowerIsBetter.to_string(), "lower_is_better");
        assert_eq!(Direction::HigherIsBetter.to_string(), "higher_is_better");
        assert_eq!(
            "lower_is_better".parse::<Direction>().unwrap(),
